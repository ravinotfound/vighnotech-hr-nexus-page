  ...
  return (
    <div className="group perspective-1000">
      <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-500 h-full bg-white relative z-10 group-hover:translate-y-[-8px] transform-gpu">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-brand-orange/5 to-brand-orange/10 opacity-30 transition-all duration-500 group-hover:opacity-50" />
        ...
        <div className="p-8 relative z-10">
          ...
          <div className="flex items-center mb-4">
            <span className="text-4xl font-bold text-gray-100 opacity-80 mr-2">0{index + 1}</span>
            <h3 className="text-xl font-bold text-gray-800 relative z-10">{feature.title}</h3>
          </div>
