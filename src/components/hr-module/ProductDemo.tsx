            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                <div className="lg:col-span-3">
                  <div className="relative rounded-xl overflow-hidden border border-gray-100 shadow-lg bg-white group hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="absolute bottom-4 right-4 z-20">
                      <Button className="bg-brand-orange hover:bg-brand-orange/90 rounded-full h-14 w-14 p-0 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110">
                ...
                <div className="lg:col-span-2 flex flex-col justify-between">
                  ...
                  <div className="mt-8">
                    <Button className="bg-brand-orange hover:bg-brand-orange/90 text-white rounded-lg px-6 py-3 hover:translate-y-[-4px] transition-transform duration-300 w-full">
                      Schedule Live Demo
                    </Button>
                  </div>
                </div>
